                ...
                <div className="space-y-10">
                    ...
                    <div>
                        <button 
                            ...
                            className="w-full py-4 bg-blue-600 text-white font-bold uppercase tracking-widest rounded-lg hover:bg-blue-500 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50 disabled:bg-gray-500 disabled:cursor-not-allowed disabled:transform-none"
                            data-cursor-hover
                        >
