                ...
                <div className="space-y-10">
                    ...
                    <div>
                        <button 
                            ...
                            // Aplicando o estilo de gradiente do footer CTA
                            className="w-full py-4 footer-cta-button text-white font-bold uppercase tracking-widest rounded-lg transition-all duration-300 transform hover:scale-[1.02] disabled:bg-gray-500 disabled:cursor-not-allowed disabled:transform-none"
                            data-cursor-hover
                        >
