                ...
                <AnimatedSection>
                    <div className="text-center mb-16">
                        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
                            <span style={{color: COLORS.blue}}>Nossos</span> <span style={{color: COLORS.yellow}}>Serviços de IA</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {services.map((service, index) => (
                             <div key={index} className="bg-[#161b22] p-8 rounded-xl border border-gray-800 transition-all duration-300 hover:-translate-y-1.5 hover:border-blue-500">
